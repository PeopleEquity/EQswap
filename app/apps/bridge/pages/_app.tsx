  ...
  return (
    <>
      <Head>
        ...
        <meta name="twitter:title" content="EquitySwap offers three pricing models suitable for companies of varying sizes, boosting liquidity and preventing market-cap inflation." />
        <title>EquitySwap</title>
      </Head>
      <NextThemeProvider>
        <StyledThemeProvider>
          <ModalProvider>
